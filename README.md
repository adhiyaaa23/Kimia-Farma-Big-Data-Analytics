...
WITH data_analisa AS (
  -- Memilih semua kolom yang dibutuhkan untuk dimasukkan ke dalam tabel data_analisa. 
    SELECT
        ft.transaction_id,
        ft.date,
        ft.branch_id,
...
-- Penyusunan query untuk membuat kolom aggregat menggunakan query case when
        CASE
